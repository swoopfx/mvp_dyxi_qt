...
Window {
    ...
    FontLoader {
        id: dyslexiaFont
        source: "assets/OpenDyslexic-Regular.otf"
    }
    ...
    Component {
        ...
        Item {
            ColumnLayout {
                ...
                Image {
                    source: "assets/images/character_guide.png"
                ...
                Button {
                    ...
                    Layout.alignment: Qt.AlignHCenter
                    background: Image {
                        source: "assets/images/button_play.png"
                        width: 150
                        height: 150
                    }
                    onClicked: {
        ...
        Item {
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    LevelButton { level: 3; title: "Tracing"; color: "#98FB98"; onClicked: stackView.push(gameLevel3) }
                }
    ...
    Component { id: gameLevel3; GameLevel3 {} }
}
