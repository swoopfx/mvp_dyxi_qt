     ...
     Column {
         ...
         Flow {
             ...
             GameItem {
                 ...
                 accentColor: "#FF8A65"
                   onClicked: stackView.push("GameItemListPage.qml",
                                             {
                                                  "itemId": 1,
                                                  "url": "https://mvp.dyxi.site/api/game-by-type",
                                                  "queryName":"type"
                                                                        })
             }
             ...
             GameItem {
                 ...
                 accentColor: "#4DB6AC"
                 onClicked: stackView.push("PageLoader.qml",                                              {
                                                "itemId": 1,
                                                "url": "https://mvp.dyxi.site/api/game-by-type",
                                                "queryName":"type"
                                                                      })
             ...
             GameItem {
                 ...
                 accentColor: "#9575CD"
                 onClicked: stackView.push("PageDefaultPlaygroundLoader.qml")
             }
